...
var naSiteNameToCode = map[string]string{
	...
	"Ass Masterpiece":              "am",
	"Classroom":                    "clsr",
	"Dirty Wives Club":             "nadwc",
	"Dorm Room":                    "drrm",
	"Dressing Room":                "tdrm",
	"FANS":                         "fans",
	"Fuck My Ass":                  "fkma",
	"Gym":                          "tgym",
	"Housewife 1 on 1":             "h1on1",
	"I Have a Wife":                "ihw",
	"My Dad's Hot Girlfriend":      "mdhg",
	"My Daughter's Hot Friend":     "mdhf",
	"My First Sex Teacher":         "mfst",
	"My Friend's Hot Girl":         "mfhg",
	"My Friend's Hot Mom":          "mfhm",
	"My Girl Loves Anal":           "mgla",
	"My Girlfriend":                "mygf",
	"My Girlfriend's Busty Friend": "mgbf",
	"My Naughty Massage":           "mnm",
	"My Wife's Hot Friend":         "mwhf",
	"Naughty America":              "nam",
	"Naughty Athletics":            "nath",
	"Naughty Bookworms":            "nbw",
	"Naughty Office":               "no",
	"Naughty Rich Girls":           "nrg",
