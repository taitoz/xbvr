<template>
  <div class="card is-shadowless">
    <div class="card-image">
      <div class="bbox"
           v-bind:style='{backgroundImage: `url("${getImageURL(actor.image_url)}")`, backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat", opacity:isAvailable(actor) ? 1.0 : isAvailOpacity, width: "195px", height: "290px"}'
